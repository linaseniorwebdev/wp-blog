    ...
    <article <?php post_class( $columns ); ?>>
        <div class="<?php echo esc_attr( implode(' ',$post_wrap_class) ); ?>">
            ...
            <div class="content-holder">
                    ...
                    <?php foreach ( $content_order_lists as $key => $content_order ) :
                        ...
                        <?php } elseif ( $content_order == 'blog-title' ) { ?>
                            <h2 class="entry-title order-position order-position-<?php echo esc_attr( $key ); ?>">
                                <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" style="font-family: 'Noto Serif JP', Sans-serif">
                                    <?php the_title(); ?>
                                </a>
                            </h2>
                        <?php
                ...
                <div class="entry-content" style="font-family: 'Noto Serif JP', Sans-serif">
                    <?php
                    $content = wp_trim_words( get_the_excerpt(), 54, '...' );
                    echo '<p>'.wp_kses_post( $content ).'</p>';
                    ?>
                </div><!-- .entry-summary -->

                <footer class="entry-footer" style="font-family: 'Noto Serif JP', Sans-serif">
